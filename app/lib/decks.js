...
export const DECKS = [
  ...
  { id: "hudson", name: "Hudson's World", emoji: "\u{1F436}", cards: [
    ...
    { l: "Hudson hates it",  r: "Hudson loves it" },
    { l: "Squirrel",         r: "Doorbell" },
    { l: "Belly rub",        r: "Bath time" },
    { l: "Puppy energy",     r: "Old man energy" },
    { l: "Tail wag",         r: "Full body wiggle" },
    { l: "Stranger danger",  r: "Instant best friend" },
    { l: "Hudson's bed",     r: "Your bed" },
    { l: "A quiet walk",     r: "Chaos on a lead" },
  ]},
  ...
  { id: "tv", name: "TV Night", emoji: "\u{1F4FA}", cards: [
    { l: "Prestige TV",      r: "Trash TV" },
    { l: "Love Island",      r: "Love Is Blind" },
    { l: "Friends",          r: "Gilmore Girls" },
    { l: "The Office",       r: "Friends" },
    { l: "Gilmore Girls",    r: "Love Island" },
    { l: "Background noise", r: "Full attention" },
    { l: "One episode",      r: "Whole season tonight" },
    { l: "Rewatch forever",  r: "Once was enough" },
    { l: "Reality TV",       r: "Scripted drama" },
    { l: "Never skip intro", r: "Always skip intro" },
  ]},
